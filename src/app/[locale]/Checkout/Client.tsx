    ...
    >
      ...
      <div className="w-1/2 mr-8">
        ...
        <div className="flex flex-col   max-w-xl">
          ...
          <div className="mb-4 flex flex-col gap-1">
            <label htmlFor="email" className="block mb-1  text-color-text-2">
              {form.email}
            </label>
            <input
              type="text"
      ...
      <div className="w-1/2 py-5 flex flex-col">
        ...
        >
          <span className="block mb-1 text-sm">{priceSection.subtotal}</span>
        ...
        >
          <span className="block mb-1 text-sm">{priceSection.shipping}</span>
        </div>
        <div
          className={`mb-4 flex flex-col   ${locale == "ar" && " items-end "}`}
        >
          <div
        ...
        <button className="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
          {priceSection.order}
        </button>
